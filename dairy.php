...
<head>
    ...
    <title>Small Basket | Dairy</title>
</head>
...
<body>
    ...
    <header>
        ...
        <nav class="navbar">
            ...
            <a style="color: #9F9F9F " href="dairy.php">DAIRY</a>
        </nav>
        <div class="icons">
    ...
    <section class="product" id="product">
        <h1 class="heading">DAIRY <span></span></h1>
        <div class="box-container">
            ...
            $sql = "SELECT * FROM products WHERE description = 'dairy'";
